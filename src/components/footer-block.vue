<template>
  <div>
            ...
            <div class="o-grid">
              ...
              <div class="o-grid__col u-5@sm">
                <a href="https://www.actua.ad/es/" target="_blank"
                  ><img
                    src="/img/logo-actua-color.jpg"
                    class="big"
                    alt="Logo de ACTUA Tech"
                /></a>
              </div>
            </div>
          </div>
    ...
    <cookie-law
      ...
      buttonClass="c-button c-button--primary"
      message="Esta página utiliza cookies para asegurarte una mejor experiencia web."
    ></cookie-law>
  </div>
</template>
